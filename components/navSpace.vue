<template>
    ...
    <div>
        <transition name="fade">
            <div v-show="showMobileMenu" class="  h-[100vh] w-[100vw] bg-gradient-to-b from-dark-900 from-10% to-dark-100 to-50% fixed top-0 flex z-100 items-center justify-center ">
