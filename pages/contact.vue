      ...
      <div class="py-2rem px-5rem tracking-wide leading-loose">
        <div class="pb-[10rem] w-[60vw]">
          <div class="flex row ">
            ...
            <svg class="hidden md:flex w-[4rem] " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <P class="pb-3 text-[1.5rem]  xl:text-[2.2rem] 2xl:text-[2.4em] ">
            無論是出於專業目的還是個人目的，我總是樂於建立新的聯繫。如果您對我有任何疑問、意見或有興趣討論潛在的機會，請通過以下渠道與我聯繫：</P>
          <P class="text-[1rem] font-bold lg:text-[1.5rem] ">(I am always open to making new connections, whether for
            professional or personal purposes. If you have any questions, comments about my work, or interested to discuss
            potential opportunities, please reach out to me via the following channels)</P>
        </div>
        <div class="flex text-[1rem] lg:text-[1.5rem] items-center">
          ...
          <div class="w-[10rem] justify-between flex ">
            <a href="https://github.com/suzuru0611/">
              <svg class="w-[2.5rem]  hover:animate-pulse " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path fill="black"
            ...
            <a href="https://www.linkedin.com/in/zuru-su-b7476a277/">
              <svg class="w-[2.5rem] hover:animate-pulse" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path fill="black"
            ...
            <a href="https://www.behance.net/zurusu/">
              <svg class="w-[2.5rem] hover:animate-pulse" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                <path fill="black"
